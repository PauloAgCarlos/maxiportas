    ...
    <?php require_once "../template/header.php" ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="processar_atualizacao_forma_de_pagamento.php" method="POST" enctype="multipart/form-data">
            <div class="block">
              ...
              <div class="block-content" >
                <div class="row justify-content-center push">
                  ...
                  <?php
                    ...
                    $selecionar_forma_de_pagamento_id = new controllers_forma_de_pagamento();
                    $idDescriptografado = base64_decode($_GET['atualizar_agregar']); 
                    
                    $id_update = $idDescriptografado;
                    $update = $selecionar_forma_de_pagamento_id->selecionar_forma_de_pagamento_id($id_update);                   
                ...
                <div style="display: flex; align-items: center; justify-content: center;">
                  ...
                  <div class="mb-4 push" style="display: flex; align-items: center; justify-content: center;">
                    <div class="block-content bg-body-light push pb-4">
                      <div>
                        <div class="col-md-12">
                          <button type="submit" name="btn_atualizar_forma_de_pagamento" class="btn btn-alt-primary">
                            <i class="fa fa-fw fa-check opacity-50 me-1"></i> Atualizar Forma de Pagamento
                          </button>
                        </div>
                      </div>
                    </div>
