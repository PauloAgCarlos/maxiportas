<?php
    ...
    if(isset($_POST['btn_cadastrar_forma_de_pagamento'])):

        $descricao = addslashes($_POST['descricao']);
        $codigo_produto_digitado = addslashes($_POST['codigo_produto']);
        $codigo_produto = "CFormPag-". $codigo_produto_digitado;
      ...
      try {
          ...
          $stmt = $pdo->prepare("INSERT INTO forma_de_pagamento (descricao, codigo_produto) VALUES (:descricao, :codigo_produto)");
