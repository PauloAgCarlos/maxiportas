...
class controllers_puxadores extends database
{
    ...
    public function inserir($descricao, $usinagem_box_tres, $medida_maxima_para_usinagem, $agregar, $unidade, $codigo_da_fabrica, $codigo_produto, $quantidade, $ponteira_obrigatoria, $referencias_do_mercado, $custo_metro, $markup, $metragem_minima, $valor, $desconto_corte, $perda, $perda_bordas, $perda_corte, $dimensao, $perda_bordas_retalho, $path_image, $ultima_alteracao, $ativo)
    {
        ...
        $insert->bindParam(9, $ponteira_obrigatoria);
        $insert->bindParam(10, $referencias_do_mercado);   
        $insert->bindParam(11, $custo_metro);         
        $insert->bindParam(12, $markup);            
        $insert->bindParam(13, $metragem_minima);           
        $insert->bindParam(14, $valor);
        $insert->bindParam(15, $desconto_corte);
        $insert->bindParam(16, $perda);
        $insert->bindParam(17, $perda_bordas);
        $insert->bindParam(18, $perda_corte);
        $insert->bindParam(19, $dimensao);
        $insert->bindParam(20, $perda_bordas_retalho);
        $insert->bindParam(21, $perda_corte_retalho);
        $insert->bindParam(22, $path_image);
        $insert->bindParam(23, $ultima_alteracao);
        $insert->bindParam(24, $ativo);
        $insert->execute();
    }
    ...
    public function atualizar_puxadores($descricao, $usinagem_box_tres, $medida_maxima_para_usinagem, $agregar, $unidade, $codigo_da_fabrica, $codigo_produto, $quantidade, $ponteira_obrigatoria, $referencias_do_mercado, $custo_metro, $markup, $metragem_minima, $valor, $desconto_corte, $perda, $perda_bordas, $perda_corte, $dimensao, $perda_bordas_retalho, $perda_corte_retalho, $ultima_alteracao, $ativo, $id_atualizar)
    {
        ...
        $atualizar_puxadores->bindParam(8, $quantidade);
        $atualizar_puxadores->bindParam(9, $ponteira_obrigatoria);
        $atualizar_puxadores->bindParam(10, $referencias_do_mercado);   
        $atualizar_puxadores->bindParam(11, $custo_metro);         
        $atualizar_puxadores->bindParam(12, $markup);            
        $atualizar_puxadores->bindParam(13, $metragem_minima);           
        $atualizar_puxadores->bindParam(14, $valor);
        $atualizar_puxadores->bindParam(15, $desconto_corte);
        $atualizar_puxadores->bindParam(16, $perda);
        $atualizar_puxadores->bindParam(17, $perda_bordas);
        $atualizar_puxadores->bindParam(18, $perda_corte);
        $atualizar_puxadores->bindParam(19, $dimensao);
        $atualizar_puxadores->bindParam(20, $perda_bordas_retalho);
        $atualizar_puxadores->bindParam(21, $perda_corte_retalho);
        $atualizar_puxadores->bindParam(22, $ultima_alteracao);
        $atualizar_puxadores->bindParam(23, $ativo);
        $atualizar_puxadores->bindParam(24, $id_atualizar);
