    ...
    <?php require_once "../template/header.php" ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="cores.php" method="POST" enctype="multipart/form-data">
            <div class="block">
                  ...
                  <div class="col-md-6">
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between;">
                      <div class="mb-1">
                        ...
                        <input type="text" value="0" class="form-control" id="custo" name="custo" placeholder="0,00" style="font-size: 0.8em;">
                      </div>
                      <div class="mb-1 ms-3">
                    ...
                    <div class="mb-3" style="display: flex; align-items: center; justify-content: space-between;">
                      ...
                      <div class="mb-1 ms-3">
                        ...
                        <input type="text" value="0" class="form-control" id="rendimento" name="rendimento" placeholder="0,00" style="font-size: 0.8em;">
                      </div>
                    ...
                    <div class="col-md-6" style="display: flex; align-items: center; justify-content: space-around;">
                      <div class="mb-4 push" style="display: flex; align-items: center; justify-content: center;">
                        <div class="block-content bg-body-light push pb-4">
                          <div>
                            <div class="col-md-12">
                              <button type="submit" name="btn_cadastrar_cores" class="btn btn-alt-primary">
                                <i class="fa fa-fw fa-check opacity-50 me-1"></i> Cadastrar cores
                              </button>
                            </div>
                          </div>
                        </div>
...
<?php include_once "cadastrar_cores.php"; ?>