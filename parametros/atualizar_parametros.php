    ...
    <?php require_once "../template/header.php" ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="processar_atualizacao_parametros.php" method="POST" enctype="multipart/form-data">
            <div class="block">
              ...
              <div class="block-content" >
                <div class="row justify-content-center push">
                  ...
                  <?php
                    ...
                    $idDescriptografado = base64_decode($_GET['atualizar_parametros']); 
                    
                    $id_update = $idDescriptografado;
                    $update = $selecionar_parametros_id->selecionar_parametros_id($id_update);                   
                    ...
                    <div class="mb-1">
                      ...
                      <div>
                        <input type="text" class="form-control" id="codigo_produto" name="codigo_produto" value="<?php
                         $codigo = substr($row_update['codigo_produto'], 7); echo addslashes($codigo); ?>" maxlength="20" minlength="2" style="font-size: 0.9em;" required>
                      </div>
                    </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="mb-1">
                      ...
                      <textarea name="observacao" id="observacao" class="form-control" cols="1" rows="1" style="font-size: 0.9em;"><?php echo $row_update['observacao']; ?></textarea>
                    </div>
                    <input type="hidden" name="id_atualizar" value="<?php $idDescriptografado = base64_decode($_GET['atualizar_parametros']); $id_update = $idDescriptografado; echo $id_update; ?>">
                  <?php }?>
                  </div>
                ...
                <div class="row justify-content-center push">
                  ...
                  <div class="mb-4 col-md-6" style="display: flex; align-items: center; justify-content: center;">
                    <div class="block-content">
                      <div class="row justify-content-center push">
                        <div class="col-md-12">
                          <button type="submit" name="btn_atualizar_parametros" class="btn btn-alt-primary">
                            <i class="fa fa-fw fa-check opacity-50 me-1"></i> Atualizar Parâmetros
                          </button>
                        </div>
                      </div>
                    </div>
