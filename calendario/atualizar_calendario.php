    ...
    <?php require_once "../template/header.php" ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="processar_atualizacao_calendario.php" method="POST" enctype="multipart/form-data">
            <div class="block">
              ...
              <div class="block-content" >
                <div class="row justify-content-center push">
                  ...
                  <?php
                    ...
                    $selecionar_calendario_id = new controllers_calendario();
                    $idDescriptografado = base64_decode($_GET['atualizar_agregar']); 
                    
                    $id_update = $idDescriptografado;
                    $update = $selecionar_calendario_id->selecionar_calendario_id($id_update);                   
                  ...
                  ?>
                    <div class="mb-1">
                      ...
                      <div style="display: flex;">
                        <input type="text" class="form-control" id="ano_mes" name="ano_mes" value="<?php echo addslashes($row_update['ano_mes']); ?>" style="font-size: 0.8em;" required>
                      </div>
                    </div>  
                    ...
                    <div class="mb-1">
                      ...
                      <div>
                        <input type="text" class="form-control" id="dias_uteis" name="dias_uteis" value="<?php echo addslashes($row_update['dias_uteis']); ?>" style="font-size: 0.9em;" required>
                      </div>
                    </div>
                ...
                <div style="display: flex; align-items: center; justify-content: center;">
                  ...
                  <div class="mb-4 push" style="display: flex; align-items: center; justify-content: center;">
                    <div class="block-content bg-body-light push pb-4">
                      <div>
                        <div class="col-md-12">
                          <button type="submit" name="btn_atualizar_calendario" class="btn btn-alt-primary">
                            <i class="fa fa-fw fa-check opacity-50 me-1"></i> Atualizar Calendário
                          </button>
                        </div>
                      </div>
                    </div>
