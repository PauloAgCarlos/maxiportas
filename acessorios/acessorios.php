                  ...
                  <div class="col-md-6">
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between;">
                      <div class="mb-1">
                        ...
                        <input type="text" value="0" class="form-control" id="custo_unitario" name="custo_unitario" placeholder="0,00" style="font-size: 0.8em;">
                      </div>
                      <div class="mb-1 ms-3">
                    ...
                    <div class="mb-3" style="display: flex; align-items: center; justify-content: space-between;">
                      ...
                      <div class="mb-1">
                        ...
                        <input type="text" value="0" class="form-control" id="desconto_corte" name="desconto_corte" placeholder="0(m^2)" style="font-size: 0.8em;">
                      </div>
                    </div>
