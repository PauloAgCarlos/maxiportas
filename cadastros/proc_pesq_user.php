...
$result_user = "SELECT * FROM clientes WHERE cnpj LIKE '%$usuarios%' OR nome LIKE '%$usuarios%' OR email LIKE '%$usuarios%' LIMIT 20";
	...
	while($row_user = mysqli_fetch_assoc($resultado_user)){ ?>
		...
		<tr>
			...
			<td class="text-center text-nowrap fw-medium" style="display: flex; justify-content: center; align-items: center;">
				...
				<a href="vermais_clientes.php?view_clientes=<?php $idCriptografado = base64_encode($row_user['id']); echo $idCriptografado; ?>">
