...
$result_agregar = "SELECT * FROM agregar ORDER BY id DESC";
...
$result_agregar = "SELECT * FROM agregar ORDER BY id DESC limit $incio, $quantidade_pg";
$resultado_agregar = mysqli_query($conn, $result_agregar);
$total_agregar = mysqli_num_rows($resultado_agregar);
            ...
            <div class="col-md-12">
              ...
              <div class="block block-rounded block-mode-loading-refresh">
                <div class="block-header block-header-default">
                  ...
                  <a class="btn btn-alt-secondary" href="agregar.php">
                    Cadastrar Agregar
                  </a>
                </div>
                  ...
                  <ul class="pagination">
                    <li>
                      ...
                      if($pagina_anterior != 0){ ?>
                        <a href="visualizar_agregar.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
                    ...
                    for($i = 1; $i < $num_pagina + 1; $i++){ ?>
                      <li><a href="visualizar_agregar.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a>
                      </li>
                    <?php } ?>
                    <li>
                      <?php
                      if($pagina_posterior <= $num_pagina){ ?>
                        <a href="visualizar_agregar.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
