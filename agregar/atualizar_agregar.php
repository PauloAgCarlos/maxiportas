    ...
    <?php require_once "../template/header.php" ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="processar_atualizacao_agregar.php" method="POST" enctype="multipart/form-data">
            <div class="block">
              <div class="block-header block-header-default">
                <a class="btn btn-alt-secondary" href="agregar.php">
                  Atualizar de Agregar
                </a>
              ...
              <div class="block-content" >
                <div class="row justify-content-center push">
                  ...
                  <?php
                    ...
                    $update = $selecionar_agregar_id->selecionar_agregar_id($id_update);                   
                ...
                <div style="display: flex; align-items: center; justify-content: center;">
                  ...
                  <div class="mb-4 push" style="display: flex; align-items: center; justify-content: center;">
                    <div class="block-content bg-body-light push pb-4">
                      <div>
                        <div class="col-md-12">
                          <button type="submit" name="btn_atualizar_agregar" class="btn btn-alt-primary">
                            <i class="fa fa-fw fa-check opacity-50 me-1"></i> Atualizar agregar
                          </button>
                        </div>
                      </div>
                    </div>
