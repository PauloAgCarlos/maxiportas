...
if(!isset($_GET['pesquisar'])){
	header("Location: visualizar_agregar.php");
}else{
...
//Contar o total de agregar
$total_agregar = mysqli_num_rows($resultado_curso);

//Seta a quantidade de agregar por pagina
$quantidade_pg = 1;

//calcular o número de pagina necessárias para apresentar os agregar
$num_pagina = ceil($total_agregar/$quantidade_pg);

//Calcular o inicio da visualizacao
$incio = ($quantidade_pg*$pagina)-$quantidade_pg;

//Selecionar os agregar a serem apresentado na página
$result_agregar = "SELECT * FROM agregar WHERE descricao LIKE '%$valor_pesquisar%' limit $incio, $quantidade_pg";
$resultado_agregar = mysqli_query($conn, $result_agregar);
$total_agregar = mysqli_num_rows($resultado_agregar);
...
<!-- END Header -->
              ...
              <div class="block block-rounded block-mode-loading-refresh">
                <div class="block-header block-header-default">
                  <h3 class="block-title">
                    Resultado da Agregar
                  </h3>
                  <a class="btn btn-alt-secondary" href="visualizar_agregar.php">
                    <i class="fa fa-arrow-left me-1"></i> Visualizar Agregar
                  </a>
                </div>
                <div class="table-responsive">
                  ...
                  <?php
                    ...
                    $selecionar_agregar = new controllers_agregar();
                    $result_agregar = $selecionar_agregar->selecionar_agregar();
                    if(count($result_agregar) > 0)
                    { ?>
                              ...
                              while($row_agregar = mysqli_fetch_assoc($resultado_agregar)){ ?>
                                <tr style="text-align: center;">
                                  ...
                                  <td class="text-center text-nowrap fw-medium" style="display: flex; justify-content: center; align-items: center;">
                                    ...
                                    <?php
                                       echo "<button class='btn' onclick='abrirModal(".$row_agregar['id'].")'><i class='fa fa-fw fa-times text-danger'></i></button>";
                                    ?>
                                  </td>
                                </tr>
                    ...
                    <ul class="pagination">
                        <li>
                            ...
                            if($pagina_anterior != 0){ ?>
                                <a href="pesquisar_agregar.php?pagina=<?php echo $pagina_anterior; ?>&pesquisar=<?php echo $valor_pesquisar; ?>" aria-label="Previous">
                        ...
                        for($i = 1; $i < $num_pagina + 1; $i++){ ?>
                            <li><a href="pesquisar_agregar.php?pagina=<?php echo $i; ?>&pesquisar=<?php echo $valor_pesquisar; ?>"><?php echo $i; ?></a></li>
                        <?php } ?>
                        <li>
                            <?php
                            if($pagina_posterior <= $num_pagina){ ?>
                                <a href="pesquisar_agregar.php?pagina=<?php echo $pagina_posterior; ?>&pesquisar=<?php echo $valor_pesquisar; ?>" aria-label="Previous">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Tem certeza de que deseja eliminar este Agregar?
                            </div>
    ...
    <script>
      ...
      document.getElementById('btnConfirmarExclusao').addEventListener('click', function() {
          window.location.href = `eliminar_agregar.php?id=${idProdutoParaExcluir}`;
      });
    </script>
  </body>
</html>
