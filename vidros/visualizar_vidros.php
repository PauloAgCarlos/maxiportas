...
$result_vidros = "SELECT * FROM vidros ORDER BY id DESC";
...
$result_vidros = "SELECT * FROM vidros ORDER BY id DESC limit $incio, $quantidade_pg";
$resultado_vidros = mysqli_query($conn, $result_vidros);
$total_vidros = mysqli_num_rows($resultado_vidros);
                  ...
                  <ul class="pagination">
                    <li>
                      ...
                      if($pagina_anterior != 0){ ?>
                        <a href="visualizar_vidros.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
                    ...
                    for($i = 1; $i < $num_pagina + 1; $i++){ ?>
                      <li><a href="visualizar_vidros.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a>
                      </li>
                    <?php } ?>
                    <li>
                      <?php
                      if($pagina_posterior <= $num_pagina){ ?>
                        <a href="visualizar_vidros.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
