...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id'])) {
    ...
    $resul = $conection_bd->query("SELECT * FROM servicos WHERE id = $idProduto");
    ...
    try {
        ...
        $stmt->execute();
        header("Location: visualizar_servicos.php?eliminado");
        exit;
    } catch (PDOException $e) {
        // echo "Erro de conexão com o banco de dados: " . $e->getMessage();
        header("Location: visualizar_servicos.php?error");
