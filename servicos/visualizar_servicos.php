...
$result_servicos = "SELECT * FROM servicos ORDER BY id DESC";
...
$result_servicos = "SELECT * FROM servicos ORDER BY id DESC limit $incio, $quantidade_pg";
$resultado_servicos = mysqli_query($conn, $result_servicos);
$total_servicos = mysqli_num_rows($resultado_servicos);
                  ...
                  <ul class="pagination">
                    <li>
                      ...
                      if($pagina_anterior != 0){ ?>
                        <a href="visualizar_servicos.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
                    ...
                    for($i = 1; $i < $num_pagina + 1; $i++){ ?>
                      <li><a href="visualizar_servicos.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a>
                      </li>
                    <?php } ?>
                    <li>
                      <?php
                      if($pagina_posterior <= $num_pagina){ ?>
                        <a href="visualizar_servicos.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Tem certeza de que deseja eliminar este Serviço?
                            </div>
