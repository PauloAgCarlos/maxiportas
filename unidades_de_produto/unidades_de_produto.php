    ...
    <?php require_once "../template/header.php" ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="unidades_de_produto.php" method="POST" enctype="multipart/form-data">
            <div class="block">
              <div class="block-header block-header-default">
                ...
                <a class="btn btn-alt-secondary" href="visualizar_unidades_de_produto.php">
                  <i class="fa fa-arrow-left me-1"></i> Visualizar Unidades de Produtos
                </a>
              </div>
              <div class="block-content" >
                <div class="row justify-content-center push">
                  <div class="col-md-12">
                    ...
                    <div class="mb-1">
                      <label class="form-label" for="abreviacao" style="font-size: 0.9em;">Abreviação</label>
                      <div>
                        <input type="text" class="form-control" id="abreviacao" name="abreviacao" placeholder="Abreviação" style="font-size: 0.9em;">
                      </div>
                    </div>
                ...
                <div class="row justify-content-center push">
                  ...
                  <div class="mb-4 col-md-6" style="display: flex; align-items: center; justify-content: center;">
                    <div class="block-content ">
                      <div class="row push">
                        <div class="col-md-12">
                          <button type="submit" name="btn_cadastrar_unidades_de_produto" class="btn btn-alt-primary">
                            <i class="fa fa-fw fa-check opacity-50 me-1"></i> Cadastrar Unidades de Produto
                          </button>
                        </div>
                      </div>
                    </div>
...
<?php include_once "cadastrar_unidades_de_produto.php"; ?>