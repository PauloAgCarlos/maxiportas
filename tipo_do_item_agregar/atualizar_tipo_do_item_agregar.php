    ...
    <?php require_once "../template/header.php" ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="processar_atualizacao_tipo_do_item_agregar.php" method="POST" enctype="multipart/form-data">
            <div class="block">
              <div class="block-header block-header-default">
                <a class="btn btn-alt-secondary">
                  Atualizar Tipo do Item Agregar
                </a>
              ...
              <div class="block-content" >
                <div class="row justify-content-center push">
                  ...
                  <?php
                    ...
                    $selecionar_tipo_do_item_agregar_id = new controllers_tipo_do_item_agregar();
                    $idDescriptografado = base64_decode($_GET['atualizar_agregar']); 
                    
                    $id_update = $idDescriptografado;
                    $update = $selecionar_tipo_do_item_agregar_id->selecionar_tipo_do_item_agregar_id($id_update);                   
                  ...
                  ?>
                    ...
                    <div class="mb-1">
                      ...
                      <div>
                        <input type="text" class="form-control" id="codigo_produto" name="codigo_produto" maxlength="20" minlength="2" value="<?php $codigo = substr($row_update['codigo_produto'], 10); echo addslashes($codigo); ?>" style="font-size: 0.9em;" required>
                      </div>
                    </div>
                ...
                <div style="display: flex; align-items: center; justify-content: center;">
                  ...
                  <div class="mb-4 push" style="display: flex; align-items: center; justify-content: center;">
                    <div class="block-content bg-body-light push pb-4">
                      <div>
                        <div class="col-md-12">
                          <button type="submit" name="btn_atualizar_tipo_do_item_agregar" class="btn btn-alt-primary">
                            <i class="fa fa-fw fa-check opacity-50 me-1"></i> Atualizar Tipo do Item Agregar
                          </button>
                        </div>
                      </div>
                    </div>
