                ...
                <div class="row justify-content-center push">
                  ...
                  ?>
                    ...
                    <div class="mb-1">
                      ...
                      <div>
                        <input type="text" class="form-control" id="codigo_produto" name="codigo_produto" maxlength="20" minlength="2" value="<?php echo addslashes($row_update['codigo_produto']); ?>" style="font-size: 0.9em;" required>
                      </div>
                    </div>
