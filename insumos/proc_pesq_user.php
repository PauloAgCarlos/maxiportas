...
$result_user = "SELECT * FROM insumos WHERE descricao LIKE '%$usuarios%' OR codigo_produto LIKE '%$usuarios%' LIMIT 20";
	...
	while($row_user = mysqli_fetch_assoc($resultado_user)){ ?>
		...
		<tr>
			...
			<td class="text-center text-nowrap fw-medium" style="display: flex; justify-content: center; align-items: center;">
				...
				<a href="vermais_insumos.php?view_insumos=<?php $idCriptografado = base64_encode($row_user['id']); echo $idCriptografado; ?>">
