...
<div class="no-gutters row">
      ...
      <main id="main-container">
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <div class="row items-push" style="display: flex; align-items: center; justify-content: center;">

            <div class="col-sm-6 col-xl-3">
              <div style="background-color: #9999ff;" class="block block-rounded text-center d-flex flex-column mb-0">
                <div class="block-content block-content-fullA flex-grow-1" style="display: flex; flex-direction: row; align-items: center; justify-content: space-around;">
                  <div class="item rounded-3 bg-body mb-3">
        ...
        <div class="block block-rounded mb-5">
            <div class="block-header block-header-default">
              <h3 class="block-title">Últimas Ordens de Serviço</h3>
            </div>
                ...
                <table class="table table-bordered table-striped table-vcenter">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-center"><i class="fa fa-eye me-1 opacity-50 text-primary"></i></td>
                    </tr>
                  </tbody>
                </table>
              </div>
