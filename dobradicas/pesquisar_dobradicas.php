...
if(!isset($_GET['pesquisar'])){
	header("Location: visualizar_dobradicas.php");
}else{
...
$result_curso = "SELECT * FROM dobradicas WHERE codigo_produto LIKE '%$valor_pesquisar%'";
$resultado_curso = mysqli_query($conn, $result_curso);

//Contar o total de dobradicas
$total_dobradicas = mysqli_num_rows($resultado_curso);
...
$result_dobradicas = "SELECT * FROM dobradicas WHERE codigo_produto LIKE '%$valor_pesquisar%' limit $incio, $quantidade_pg";
              ...
              <div class="block block-rounded block-mode-loading-refresh">
                <div class="block-header block-header-default">
                  <h3 class="block-title">
                    Resultado da Dobradiças
                  </h3>
                  <a class="btn btn-alt-secondary" href="visualizar_dobradicas.php">
                    <i class="fa fa-arrow-left me-1"></i> Visualizar Dobradiças
                  </a>
                </div>
                    ...
                    <ul class="pagination">
                        <li>
                            ...
                            if($pagina_anterior != 0){ ?>
                                <a href="pesquisar_dobradicas.php?pagina=<?php echo $pagina_anterior; ?>&pesquisar=<?php echo $valor_pesquisar; ?>" aria-label="Previous">
                        ...
                        for($i = 1; $i < $num_pagina + 1; $i++){ ?>
                            <li><a href="pesquisar_dobradicas.php?pagina=<?php echo $i; ?>&pesquisar=<?php echo $valor_pesquisar; ?>"><?php echo $i; ?></a></li>
                        <?php } ?>
                        <li>
                            <?php
                            if($pagina_posterior <= $num_pagina){ ?>
                                <a href="pesquisar_dobradicas.php?pagina=<?php echo $pagina_posterior; ?>&pesquisar=<?php echo $valor_pesquisar; ?>" aria-label="Previous">
