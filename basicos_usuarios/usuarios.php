                ...
                <div class="row justify-content-center push">
                  ...
                  <div class="mb-4 col-md-6" style="display: flex; align-items: center; justify-content: center;">
                    <div class="block-content Abg-body-light">
                      <div class="row justify-content-center push">
                        <div class="col-md-12">
                          <button type="submit" name="btn_cadastrar_basicos_usuarios" class="btn btn-alt-primary">
                            <i class="fa fa-fw fa-check opacity-50 me-1"></i> Cadastrar Usuários
                          </button>
                        </div>
                      </div>
                    </div>
...
<?php include_once "cadastrar_usuarios.php"; ?>