                ...
                <div class="row justify-content-center push">
                  ...
                  ?>
                    ...
                    <div class="mb-1">
                      ...
                      <div>
                        <input type="text" class="form-control" id="codigo_interno" name="codigo_interno" maxlength="50" minlength="2" value="<?php echo $row_update['codigo_interno']; ?>" style="font-size: 0.9em;">
                      </div>
                    </div>
