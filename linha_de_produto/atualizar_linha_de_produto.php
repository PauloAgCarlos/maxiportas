    ...
    <?php require_once "../template/header.php" ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-full content-boxed">
          <!-- New Post -->
          <form action="processar_atualizacao_linha_de_produto.php" method="POST" enctype="multipart/form-data">
            <div class="block">
              <div class="block-header block-header-default">
                <a class="btn btn-alt-secondary" href="linha_de_produto.php">
                  Atualizar de Linha de Produto
                </a>
              ...
              <div class="block-content" >
                <div class="row justify-content-center push">
                  ...
                  <?php
                    ...
                    $idDescriptografado = base64_decode($_GET['atualizar_linha_de_produto']); 
                    
                    $id_update = $idDescriptografado;
                    $update = $selecionar_linha_de_produto_id->selecionar_linha_de_produto_id($id_update);                   
                  ...
                  ?>
                    ...
                    <div class="mb-1">
                      ...
                      <div>
                        <input type="text" class="form-control" id="codigo_interno" name="codigo_interno" maxlength="6" minlength="2" value="<?php echo $row_update['codigo_interno']; ?>" style="font-size: 0.9em;" required>
                      </div>
                    </div>
                    ...
                    <div class="mb-3" style="display: flex; align-items: center; justify-content: space-between;">
                      ...
                      <div class="mb-1 ms-4">
                        ...
                        <input type="hidden" name="id_atualizar" value="<?php $idDescriptografado = base64_decode($_GET['atualizar_linha_de_produto']); $id_update = $idDescriptografado; echo $id_update; ?>">
                      </div>
                      <?php } ?>
                    </div>
                ...
                <div style="display: flex; align-items: center; justify-content: center;">
                  ...
                  <div class="mb-4 push" style="display: flex; align-items: center; justify-content: center;">
                    <div class="block-content bg-body-light push pb-4">
                      <div>
                        <div class="col-md-12">
                          <button type="submit" name="btn_atualizar_linha_de_produto" class="btn btn-alt-primary">
