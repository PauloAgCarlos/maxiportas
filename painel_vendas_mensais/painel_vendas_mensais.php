                ...
                <div>
                  <style>
                   ...
                   <main id="main_grafico">
                      <section class="child_grafico"><?php include "graficoBarVendasMensaisValor.php"; ?></section> 
                  </main>
                </div>
                ...
                <div>
                  <style>
                   ...
                   <main id="main_grafico_quantidade">
                      <section class="child_grafico_quantidade"><?php include "graficoBarVendasMensaisQuantidade.php"; ?></section> 
                  </main>
                </div>
