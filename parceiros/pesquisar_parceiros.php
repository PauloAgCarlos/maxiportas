<?php 
   ...
   require_once "../config.php";
    ...
    //Selecionar todos os parceiros da tabela
    $result_curso = "SELECT * FROM parceiros WHERE cnpj LIKE '%$valor_pesquisar%'";
    $resultado_curso = mysqli_query($conn, $result_curso);
    
    //Contar o total de parceiros
    $total_parceiros = mysqli_num_rows($resultado_curso);
    
    //Seta a quantidade de parceiros por pagina
    $quantidade_pg = 1;
    
    //calcular o número de pagina necessárias para apresentar os parceiros
    $num_pagina = ceil($total_parceiros/$quantidade_pg);
    
    //Calcular o inicio da visualizacao
    $incio = ($quantidade_pg*$pagina)-$quantidade_pg;
    
    //Selecionar os parceiros a serem apresentado na página
    $result_parceiros = "SELECT * FROM parceiros WHERE cnpj LIKE '%$valor_pesquisar%' limit $incio, $quantidade_pg";
    $resultado_parceiros = mysqli_query($conn, $result_parceiros);
    $total_parceiros = mysqli_num_rows($resultado_parceiros);
...
<!-- END Header -->
            ...
            <div class="col-md-12">
              ...
              <div class="block block-rounded block-mode-loading-refresh">
                <div class="block-header block-header-default">
                  ...
                  Resultado da Pesquisa do Parceiro
                  </h3>
                  <a class="btn btn-alt-secondary" href="parceiros.php">
                    <i class="fa fa-arrow-left me-1"></i> Cadastrar Parceiros
                  </a>
                </div>
                  ...
                  <ul class="pagination" style="display: flex; align-items: center; justify-content: space-between; width: 20%; margin: auto;">
                    <li>
                      ...
                      if($pagina_anterior != 0){ ?>
                        <a href="visualizar_parceiros.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous">
                    ...
                    for($i = 1; $i < $num_pagina + 1; $i++){ ?>
                      <li><a href="visualizar_parceiros.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a>
                      </li>
                    <?php } ?>
                    <li>
                      <?php
                      if($pagina_posterior <= $num_pagina){ ?>
                        <a href="visualizar_parceiros.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Tem certeza de que deseja eliminar este Parceiro?
                            </div>
    ...
    <script>
      ...
      document.getElementById('btnConfirmarExclusao').addEventListener('click', function() {
          window.location.href = `eliminar_parceiros.php?id=${idProdutoParaExcluir}`;
      });
    </script>
