                  ...
                  <div class="blockA">
                      <div class="block-header">
                        <?php
                          ...
                          $id_user_get = base64_decode($_GET['view']);
                          $result_travessas = $conn->prepare("SELECT nome_cliente FROM pedidos_dos_clientes WHERE id = :id");
                      ...
                      <div class="row justify-content-center push">
                        ...
                        <div class="row">
                          <div class="col-md-4 mt-5">                          
                            <input type="hidden" name="id_atualizar" value="<?php $idDescriptografado = base64_decode($_GET['view']); $id_update = $idDescriptografado; echo $id_update; ?>">
                            <?php } ?>
