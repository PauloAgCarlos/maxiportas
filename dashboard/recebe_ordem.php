<?php
    ...
    if(isset($_POST['btn_incluir']))
    {
        ...
        if($id_unik)
        {
            ...
            // Valores Clientes
            $valor_item_cliente = $_POST['valor_item_cliente'];
